            ...
            <div className="col-md-5 border-right">
              <div className="p-3 py-5">
                ...
                <div className="col-md-12"><label className="labels">Email ID</label><input type="text" className="form-control" placeholder="enter email id" /></div>
                  ...
                  <div className="col-md-12"><label className="labels">Pin code</label><input type="text" className="form-control" placeholder="enter address line 2"  /></div>
                  ...
                  <div className="col-md-12"><label className="labels">Landmark</label><input type="text" className="form-control" placeholder="enter address line 2"  /></div>
                   </div>
                <div className="row mt-3">
